...
class Manual_Classifier:
    ...
    def get_data(self):
        ...
        if self.all_data:
            ...
            element = self.con.execute("SELECT id, captcha_string, image, correct FROM "+self.name+" WHERE captcha_string = \'penguin on ice\' AND correct = 0 ORDER BY captcha_string LIMIT 1").fetchone()
